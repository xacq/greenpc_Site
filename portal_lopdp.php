...
<style>
  .fab-back-mockup {
    ...
    padding: 12px 20px;
    border-radius: 999px;
    background: linear-gradient(135deg, #0b2033 0%, #1b6fa8 100%);
    color: #fff;
    ...
    border: none;
    cursor: pointer;
    box-shadow: 0 6px 24px rgba(27, 111, 168, 0.45), 0 2px 6px rgba(0,0,0,0.18);
  ...
  .fab-back-mockup:hover {
    ...
    box-shadow: 0 10px 32px rgba(27, 111, 168, 0.55), 0 3px 8px rgba(0,0,0,0.22);
    color: #fff;
    text-decoration: none;
  }
