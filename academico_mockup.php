...
<style>
  .fab-back-mockup {
    ...
    border: none;
    cursor: pointer;
    box-shadow: 0 6px 24px rgba(67, 24, 255, 0.45), 0 2px 6px rgba(0,0,0,0.18);
  ...
  .fab-back-mockup:hover {
    ...
    box-shadow: 0 10px 32px rgba(67, 24, 255, 0.55), 0 3px 8px rgba(0,0,0,0.22);
    color: #fff;
    text-decoration: none;
  }
...
<a id="fabBackMockup" class="fab-back-mockup" href="./programacion.php" role="button" aria-label="Regresar a Programacion a la Medida">
