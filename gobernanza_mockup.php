...
<style>
  .fab-back-mockup {
    ...
    padding: 12px 20px;
    border-radius: 999px;
    background: linear-gradient(135deg, #0a7c7c 0%, #14b8b8 100%);
    color: #fff;
    ...
    border: none;
    cursor: pointer;
    box-shadow: 0 6px 24px rgba(10, 124, 124, 0.45), 0 2px 6px rgba(0,0,0,0.18);
  ...
  .fab-back-mockup:hover {
    ...
    box-shadow: 0 10px 32px rgba(10, 124, 124, 0.55), 0 3px 8px rgba(0,0,0,0.22);
    color: #fff;
    text-decoration: none;
  }
